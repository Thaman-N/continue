// Prompt formatting utilities adapted from Continue.dev
...
export class PromptFormatter {
  private formatters: { [key: string]: (msgs: ChatMessage[]) => string } = {
  ...
  formatMessages(messages: ChatMessage[], options: PromptFormatterOptions = {}): string {
  ...
  buildContextualPrompt(
    userMessage: string,
    contextItems: Array<{ name: string; content: string; description?: string }>,
    systemPrompt?: string
  ): ChatMessage[] {
