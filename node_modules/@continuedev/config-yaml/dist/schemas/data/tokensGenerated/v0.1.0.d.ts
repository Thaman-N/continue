export declare const tokensGeneratedEventSchema_0_1_0: import("zod").ZodObject<Pick<import("zod").objectUtil.extendShape<{
...
export declare const tokensGeneratedEventSchema_0_1_0_noCode: import("zod").ZodObject<Pick<import("zod").objectUtil.extendShape<{
    eventName: import("zod").ZodString;
    schema: import("zod").ZodString;
    timestamp: import("zod").ZodString;
    userId: import("zod").ZodString;
