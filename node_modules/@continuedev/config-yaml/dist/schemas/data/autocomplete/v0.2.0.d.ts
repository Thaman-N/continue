export declare const autocompleteEventSchema_0_2_0: import("zod").ZodObject<Pick<import("zod").objectUtil.extendShape<{
...
export declare const autocompleteEventSchema_0_2_0_noCode: import("zod").ZodObject<Omit<Pick<import("zod").objectUtil.extendShape<{
    eventName: import("zod").ZodString;
    schema: import("zod").ZodString;
    timestamp: import("zod").ZodString;
    userId: import("zod").ZodString;
    ...
    disableInFiles: import("zod").ZodOptional<import("zod").ZodArray<import("zod").ZodString, "many">>;
}>, "time" | "disable" | "maxPromptTokens" | "debounceDelay" | "maxSuffixPercentage" | "prefixPercentage" | "template" | "onlyMyCode" | "eventName" | "schema" | "timestamp" | "userId" | "userAgent" | "selectedProfileId" | "transform" | "multilineCompletions" | "slidingWindowPrefixPercentage" | "slidingWindowSize" | "useCache" | "useRecentlyEdited" | "useImports" | "accepted" | "prefix" | "suffix" | "prompt" | "completion" | "modelProvider" | "modelName" | "cacheHit" | "filepath" | "gitRepo" | "completionId" | "uniqueId">, "prefix" | "suffix" | "prompt" | "completion">, "strip", import("zod").ZodTypeAny, {
    time: number;
    disable: boolean;
    maxPromptTokens: number;
    debounceDelay: number;
