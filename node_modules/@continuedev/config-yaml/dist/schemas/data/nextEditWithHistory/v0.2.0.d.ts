...
}>, "eventName" | "schema" | "timestamp" | "userId" | "userAgent" | "selectedProfileId" | "previousEdits" | "fileURI" | "workspaceDirURI" | "beforeContent" | "afterContent" | "beforeCursorPos" | "afterCursorPos" | "context">, "strip", import("zod").ZodTypeAny, {
    eventName: string;
    schema: string;
    timestamp: string;
    userId: string;
...
export declare const nextEditEventSchema_0_2_0_noCode: import("zod").ZodObject<Omit<Pick<import("zod").objectUtil.extendShape<{
    ...
    context: import("zod").ZodString;
}>, "eventName" | "schema" | "timestamp" | "userId" | "userAgent" | "selectedProfileId" | "previousEdits" | "fileURI" | "workspaceDirURI" | "beforeContent" | "afterContent" | "beforeCursorPos" | "afterCursorPos" | "context">, "previousEdits" | "fileURI" | "workspaceDirURI" | "beforeContent" | "afterContent" | "context">, "strip", import("zod").ZodTypeAny, {
    eventName: string;
    schema: string;
    timestamp: string;
    userId: string;
