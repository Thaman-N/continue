...
export type SecretLocation = OrgSecretLocation | PackageSecretLocation | UserSecretLocation | NotFoundSecretLocation | ModelsAddOnSecretLocation | FreeTrialSecretLocation | LocalEnvSecretLocation;
...
export interface FoundSecretResult {
    found: true;
    secretLocation: OrgSecretLocation | PackageSecretLocation | ModelsAddOnSecretLocation | FreeTrialSecretLocation | LocalEnvSecretLocation;
    fqsn: FQSN;
}
